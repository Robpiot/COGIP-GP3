import LastInvoices from './LastInvoices.jsx';
import LastContacts from './LastContacts.jsx';
import LastCompanies from './LastCompanies.jsx';
    ...
    return (
        <div className="page">
            <div className="home">
                ...
                <img src="/public/img/homeLogo.png" className="homeLogo" alt="homeLogo"/>
            </div>
            ...
            <div className="invoices">
                <LastInvoices />
                <img src="/public/img/imgCalpin.png" className="calepin" alt="calepinImg"/>
                <LastContacts />
                <img src="/public/img/ampoule.png" className="ampoule" alt="ampoule"/>
                <LastCompanies />
            </div>
            <div className="endPage">
                <h2 className="endTitle">Work Better in your Company</h2>
                <img src="/public/img/phone.png" className="phoneImg" alt="phone"/>
