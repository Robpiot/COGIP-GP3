    ...
    return (
        <div className="page">
            ...
            <div className="svgSection">
                <svg width="100%" height="100%" viewBox="0 0 1299 112" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="endPage">
                ...
                <svg className="svgYellow" width="100%" height="100%" viewBox="0 0 772 409" fill="none" xmlns="http://www.w3.org/2000/svg">
